...
public class StylePropertyField
    ...
    public StylePropertyField( Property<StylePropertyValue> prop, IAppContext context, IPanelSite site ) {
        this.prop = prop;
        this.title.set( (String)prop.info().getDescription().orElse( "" ) );
        this.editors = StylePropertyEditor.forValue( prop, context, site );
    }
