...
public class CSVFileImporter implements Importer {
    ...
    public void init(@SuppressWarnings("hiding") ImporterSite site, IProgressMonitor monitor) {
        ...
        try {
            ImportResponse response = service.importFile(new FileInputStream(file), file.getName(),
...
//                    "my message");
    ...
    public void createPrompts(IProgressMonitor monitor) throws Exception {
        ...
        // .description.put( "A ZIP file can use different charsets to encode
        // filenames. If unsure use UTF8." )
    ...
    public Composite createResultViewer(Composite parent) {
        ...
        if (importJob != null) {
            ...
            ((TableColumnLayout) table.getParent().getLayout()).setColumnData(actionsNameCol.getColumn(),
                    new ColumnPixelData(80, false));
