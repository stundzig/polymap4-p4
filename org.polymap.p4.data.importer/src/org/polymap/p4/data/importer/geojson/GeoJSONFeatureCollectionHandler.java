...
/**
 * copied from gt-geotools to support CRS inside of feature definitions
 *
 * @author Steffen Stundzig
 */
public class GeoJSONFeatureCollectionHandler extends DelegatingHandler<SimpleFeature> 
    ...
    List stack;
    private ContentHandler currentFeatureHandler = NULL;
   
    public GeoJSONFeatureCollectionHandler() {
        this(null, null);
    }

    public GeoJSONFeatureCollectionHandler(SimpleFeatureType featureType, AttributeIO attio) {
        if (featureType != null) {
    ...
    public boolean startArray() throws ParseException, IOException {
        if (delegate == UNINITIALIZED) {
            // FIX HERE sst
            currentFeatureHandler = new GeoJSONFeatureHandler(builder, attio);
            delegate = currentFeatureHandler;
            // 
            if (crs != null) {
